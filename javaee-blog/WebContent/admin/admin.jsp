<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.*,java.sql.ResultSet "%>
...
<body style="background-image:url(/Blog/img/xixi.jpg); background-size:cover;background-attachment:fixed;" no-repeat>
	...
	<div class="container" id="main">
		...
		<div id="header">
			<div>
				<h2>
					<a href="/Blog/login.html">MyBlog-管理</a>
				</h2>
		...
		<div class="admin_div">
			...
			<c:if test="${sessionScope.manageuser!=null}">
				<table border='1'>
					<tr>
						<th>序号</th>
						<th>标题</th>
					...
					%>
					<tr >
						<td width="100" height="40"><%=rs.getInt("id")%></td>
						<td width="100" height="40"><%=rs.getString("title")%></td>
						<td width="100" height="40"><%=rs.getString("author")%></td>
						<td width="100" height="40"><%=rs.getString("sort")%></td>
						<td width="100" height="40"><%=rs.getTimestamp("time")%></td>
						<td width="100" height="40"><%=rs.getInt("star")%></td>
						<td width="100" height="40"><%=rs.getInt("comment")%></td>
						<td width="100" height="40"><%=rs.getInt("visit")%></td>
		...
		<div class="admin_div">
			...
			<c:forEach var="a" items="${articles}">
				<div class="list-group-item">
					...
					<div class="r_div">
						<span>${a.time}</span> <a
							href="/Blog/AdminDataServlet?op=edit_article&&article_id=${a.id}">
