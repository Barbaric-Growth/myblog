...
public class ArticleService {
	...
	public Article getCommunityPreviousArticle(String time) {
		// TODO Auto-generated method stub
		return dao.getCommunityANearArticle(time, dao.LESS);
	}
	...
	public Object getCommunityNextArticle(String time) {
		// TODO Auto-generated method stub
		return dao.getCommunityANearArticle(time, dao.MORE);
	}
	/**
	 * 获取文章的数量 或 分类的数量
	 * 
	...
	public List<Article> getCommunityArticle(String column, String value) {
		// TODO Auto-generated method stub
		return dao.getCommunityArticleByColumn(column, value);
	}
	...
	public Map getCommunitySortAndCount() {
		// TODO Auto-generated method stub
		return dao.getCommunityColumAndCount(dao.SEARCH_SORT);
	}
	...
	public List getCommunityArticle() {
		// TODO Auto-generated method stub
		List<Article> list = dao.getAllCommunityArticle();
		for (Article a : list) {
			ArticleUtils.cutContent(list);
			ArticleUtils.cutTime(list);
		}
	...
	public Map getCommunitySortAndAirticle(String sort_name) {
		// TODO Auto-generated method stub
		Map map = new HashMap();
		List<Article> articleBySort = null;
		...
		// 获取所有分类
		if (sort_name.equals("all") || StringUtils.isEmpty(sort_name)) {
			List<String> sorts = dao.getCommunityAllSort();

			for (int i = 0; i < sorts.size(); i++) {
				String sort = sorts.get(i);
				articleBySort = dao.getCommunityArticleByColumn("sort", sort);
				ArticleUtils.cutTime(articleBySort);
				map.put(sort, articleBySort);
			}
		} else {
			// 获取单个分类
			articleBySort = dao.getCommunityArticleByColumn("sort", sort_name);
			ArticleUtils.cutTime(articleBySort);
			map.put(sort_name, articleBySort);
		}
		return map;
	...
	//获取社区阅读排行
	public List getCommunityVisitRank() {
		// TODO Auto-generated method stub
		List list = dao.getCommunityVisitRank();
		if (list.size() > 10) {
			for (int i = 10; i < list.size(); i++) {
				list.remove(i);
			}
	...
	public int starCommunityArticle(int id) {
		// TODO Auto-generated method stub
		return dao.star_Communityarticle(id);
	}
	...
	public void addCommunityVisit(int article_id) {
		// TODO Auto-generated method stub
		dao.addCommunityVisit(article_id);
	}

	public List getCommunityAllSort() {
		// TODO Auto-generated method stub
		return dao.getCommunityAllSort();
	}



	public ResultSet getCommunity() {
		// TODO Auto-generated method stub
		return dao.getCommunity();
	}

	
	public List<Article> fengYe(int pageIndex,int pageSize){

		return dao.fengYe(pageIndex, pageSize);

	}
	public List<Article> CommunityfengYe(int pageIndex,int pageSize){

		return dao.CommunityfengYe(pageIndex, pageSize);
