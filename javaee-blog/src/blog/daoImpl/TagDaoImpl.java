...
public class TagDaoImpl implements TagDao {
	...
	@Override
	public List getCommunityAllTag() {
		// TODO Auto-generated method stub

		String sql = "SELECT  distinct(tag)  FROM t_communitytag";
		List<Tag> list = null;
		try {
			PreparedStatement ps = conn.prepareStatement(sql);
			ResultSet rs = ps.executeQuery();
	...
	@Override
	public List getCommunityTagByColumn(String column, String value) {
		// TODO Auto-generated method stub
		String sql = "select * from t_communitytag where " + column + "=?";
		List list = null;
		try {
			PreparedStatement ps = conn.prepareStatement(sql);
			ps.setString(1, value);
